...
const Results = () => {
  ...
  return (
    <>
      <Header></Header>
      <div className="grid-col-1 md:flex max-w-6xl mx-auto mb-10 items-baseline">
        <div className=" grid-item text-5xl font-bold ml-10">{pbxModel}</div>
        <div className=" grid-item mx-auto my-5 md:my-0 justify-center md:items-center">
        ...
        <Link
          href={"/"}
          onClick={""}
          className="px-4 py-2 mr-10 text-md font-medium hidden md:flex text-gray-900 bg-white border border-gray-200 rounded-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-700 dark:border-gray-600 dark:text-white dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-blue-500 dark:focus:text-white"
        >
          Start Over
        </Link>
      </div>
      <div className="flex mx-auto items-center max-w-6xl gap-20">
        ...
        <AnswersTable
          ...
          pbxModel={pbxModel}
        ></AnswersTable>
        <img src={`/img/${pbxModel}.png`} alt={pbxModel} className=" mr-20 lg:flex hidden" />
      </div>
    </>
  );
};
