    ...
    <div className="flex flex-col min-h-screen">
      ...
      <div className="max-w-lg mx-auto mt-10 px-10">
        ...
        <div className="mt-10">
          {" "}
          <Link
            href={`/results/?ipLines=${ipLines}&fxsPorts=${fxsPorts}&fxoPorts=${fxoPorts}&concurrentCalls=${concurrentCalls}&callRecording=${callRecording}&isCallCenter=${isCallCenter}&callCenterAgents=${callCenterAgents}`}
